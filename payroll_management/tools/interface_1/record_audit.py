...
class RecordAudit(Tool):
    ...
    def invoke(data: Dict[str, Any], **kwargs) -> str:
        ...
        result = {"tool": "record_audit", "ok": True, "received": kwargs}
        # Always write an audit row to match SOP "every change must log".
        _write_audit(data, acting_user_id or "system", "meta", "read", "record_audit")
    ...
    def get_info() -> Dict[str, Any]:
        return {
            ...
            "function": {
                "name": "record_audit",
                "description": "Write a generic audit log entry (used across flows).",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "acting_user_id": {
