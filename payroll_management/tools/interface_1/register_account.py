...
class RegisterAccount(Tool):
    ...
    def invoke(data: Dict[str, Any], **kwargs) -> str:
        ...
        result = {"tool": "register_account", "ok": True, "received": kwargs}
        # Always write an audit row to match SOP "every change must log".
        _write_audit(data, acting_user_id or "system", "meta", "read", "register_account")
    ...
    def get_info() -> Dict[str, Any]:
        return {
            ...
            "function": {
                ...
                "description": "Provision a user account (validation, optional approvals, audit).",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "acting_user_id": {
